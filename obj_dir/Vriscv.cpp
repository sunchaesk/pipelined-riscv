...
VL_INLINE_OPT void Vriscv::_sequent__TOP__1(Vriscv__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->riscv__DOT__id_ex_imm = ((IData)(vlTOPp->reset)
                                      ? 0U : vlTOPp->riscv__DOT__ID_unit__DOT__immediate_temp);
    vlTOPp->riscv__DOT__id_ex_regwrite_d = (1U & ((~ (IData)(vlTOPp->reset)) 
                                                  & ((IData)(vlTOPp->riscv__DOT__ID_unit__DOT__control_signal_unit__DOT__control_signals) 
                                                     >> 6U)));
    vlTOPp->riscv__DOT__id_ex_memwrite_d = (1U & ((~ (IData)(vlTOPp->reset)) 
                                                  & ((IData)(vlTOPp->riscv__DOT__ID_unit__DOT__control_signal_unit__DOT__control_signals) 
                                                     >> 4U)));
    vlTOPp->riscv__DOT__id_ex_jump_d = (1U & ((~ (IData)(vlTOPp->reset)) 
                                              & (IData)(vlTOPp->riscv__DOT__ID_unit__DOT__control_signal_unit__DOT__control_signals)));
    vlTOPp->riscv__DOT__id_ex_branch_d = (1U & ((~ (IData)(vlTOPp->reset)) 
                                                & ((IData)(vlTOPp->riscv__DOT__ID_unit__DOT__control_signal_unit__DOT__control_signals) 
                                                   >> 1U)));
    vlTOPp->riscv__DOT__id_ex_alu_src_d = (1U & ((~ (IData)(vlTOPp->reset)) 
                                                 & ((IData)(vlTOPp->riscv__DOT__ID_unit__DOT__control_signal_unit__DOT__control_signals) 
                                                    >> 5U)));
    if (vlTOPp->reset) {
        ...
        vlTOPp->riscv__DOT__id_ex_result_src_d = (3U 
                                                  & ((IData)(vlTOPp->riscv__DOT__ID_unit__DOT__control_signal_unit__DOT__control_signals) 
                                                     >> 2U));
        vlTOPp->riscv__DOT__id_ex_pc = vlTOPp->riscv__DOT__IF_unit__DOT__curr_count;
        vlTOPp->riscv__DOT__id_ex_pc_plus_4 = ((IData)(4U) 
                                               + vlTOPp->riscv__DOT__IF_unit__DOT__curr_count);
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        vlTOPp->riscv__DOT__id_ex_rd = (0x1fU & (vlTOPp->riscv__DOT__if_id_instr 
                                                 >> 7U));
    }
    vlTOPp->riscv__DOT__id_ex_alu_control_d = ((IData)(vlTOPp->reset)
                                                ? 0U
                                                : (
                                                   (0x40U 
    ...
    vlTOPp->riscv__DOT__if_id_instr = ((IData)(vlTOPp->reset)
                                        ? 0U : vlTOPp->riscv__DOT__IF_unit__DOT__instr_mem
                                       [(0xffU & (vlTOPp->riscv__DOT__IF_unit__DOT__curr_count 
                                                  >> 2U))]);
    ...
    vlTOPp->riscv__DOT__ID_unit__DOT__control_signal_unit__DOT__control_signals 
        ...
        [vlTOPp->__Vtableidx1];
    vlTOPp->riscv__DOT__IF_unit__DOT__curr_count = 
        ((IData)(vlTOPp->reset) ? 0U : vlTOPp->riscv__DOT__IF_unit__DOT__next_count);
